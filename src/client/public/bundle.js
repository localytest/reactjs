...
/***/ function(module, exports, __webpack_require__) {
	...
	var _messageBox = __webpack_require__(/*! ./messageBox.jsx */ 169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _subMessage = __webpack_require__(/*! ./subMessage.jsx */ 170);
	
	var _subMessage2 = _interopRequireDefault(_subMessage);
	...
	var MessageBox = function (_React$Component) {
	    ...
	    function MessageBox(props) {
	        ...
	        _this.state = {
	            isVisible: true,
	            messages: ['Let\'s start from scratch', 'Installing and Configuring Webpack', 'Setting Up Babel-Loader', 'Adding Some Complexity', 'Making Webpack Watch Changes', 'Using npm as a tool runner', 'Adding some files', 'Summary']
	        };
	        return _this;
	    }
	    ...
	    _createClass(MessageBox, [{
	        ...
	        value: function render() {
	            ...
	            var messages = this.state.messages.map(function (message) {
	                return _react2.default.createElement(_subMessage2.default, { message: message });
	            });
	
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement('input', { ref: 'newMessage', type: 'text' }),
	                _react2.default.createElement(
	                    'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SubMessage = function (_React$Component) {
	    _inherits(SubMessage, _React$Component);
	
	    function SubMessage() {
	        _classCallCheck(this, SubMessage);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SubMessage).apply(this, arguments));
	    }
